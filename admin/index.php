...
$q_pesanan = mysqli_query($koneksi, "SELECT * FROM transaksi");
$total_pesanan = mysqli_num_rows($q_pesanan);

/* TOTAL CUSTOMER */

$q_customer = mysqli_query($koneksi, "SELECT * FROM users WHERE role='customer'");
                    ...
                    <?php while($d = mysqli_fetch_assoc($q_latest)) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if($d['status_pembayaran'] == 'paid'){ ?>
